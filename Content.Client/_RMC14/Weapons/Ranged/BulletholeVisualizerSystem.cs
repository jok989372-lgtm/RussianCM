...
public sealed partial class BulletholeVisualizerSystem : VisualizerSystem<BulletholeComponent>
{
    ...
    protected override void OnAppearanceChange(EntityUid uid, BulletholeComponent component, ref AppearanceChangeEvent args)
    {
        ...
        if (valid)
        {
            _sprite.LayerSetRsi((uid, sprite), BulletholeVisualsLayers.Bullethole, new ResPath(BulletholeRsiPath), state);
        }
    }
}
