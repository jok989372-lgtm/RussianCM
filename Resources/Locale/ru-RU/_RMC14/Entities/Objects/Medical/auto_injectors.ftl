...
ent-RMCDyloveneAutoInjector = автоинъектор диловена
  .desc = Автоинъектор, заряженный 3 дозами по 15 ед. Диловена — распространённого лекарства от токсического урона. Можно пополнить в торговых автоматах Weya-Med.

ent-RMCIronAutoInjector = автоинъектор железа
  .desc = Автоинъектор, заряженный 3 дозами железа — химического вещества, широко применяемого для лечения кровопотери.

ent-RMCDermalineAutoInjector = автоинъектор дермалина
  .desc = Автоинъектор, заряженный 3 дозами Дермалина — продвинутого химического средства для лечения ожогов.
