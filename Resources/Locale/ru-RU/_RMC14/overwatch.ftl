rmc-overwatch-console-title = Консоль овервотча
rmc-overwatch-console = Овервотч
...
rmc-overwatch-console-message-squad = Отправить сообщение отряду
rmc-overwatch-console-squad-objectives = Цели отряда
rmc-overwatch-console-show-squad-info = Показать сведения об отряде
rmc-overwatch-console-hide-squad-info = Скрыть сведения об отряде
rmc-overwatch-console-squad-monitor = Монитор отряда
rmc-overwatch-console-supply-drop = Сброс припасов
rmc-overwatch-console-orbital-bombardment = Орбитальная бомбардировка
rmc-overwatch-console-monitor = Монитор
rmc-overwatch-console-shown-all = Показаны: все
...
rmc-overwatch-console-location = Местоположение
...
rmc-overwatch-console-launch-supply-drop = Запустить сброс припасов
rmc-overwatch-console-confirm-supply-drop = Подтвердить сброс припасов?
rmc-overwatch-console-save = Сохранить
rmc-overwatch-console-max-coordinates = Максимум 3 сохранённые координаты. Сначала будут перезаписаны самые старые.
...
rmc-overwatch-console-promote-squad-leader = Назначить морпеха командиром отряда
...
rmc-overwatch-console-objective-secondary = [bold]Вторичная цель[/bold]
