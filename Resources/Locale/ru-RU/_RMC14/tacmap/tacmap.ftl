...
ui-tactical-map-centre-button = Центрировать
...
ui-tactical-map-blip-size-label = Размер маркера: {$size}x
ui-tactical-map-line-width-label = Толщина линии: {$width}px

ui-tactical-map-color-black = Чёрный
...
ui-tactical-map-color-green = Зелёный
ui-tactical-map-color-brown = Коричневый

ui-tactical-map-labels-mode-area = Область
ui-tactical-map-labels-mode-tactical = Тактический
ui-tactical-map-labels-mode-none = Без меток

ui-tactical-map-follow-player-active = Остановить
ui-tactical-map-follow-player-inactive = Центрировать
