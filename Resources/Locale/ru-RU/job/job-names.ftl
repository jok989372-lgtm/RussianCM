job-name-warden = Тюремный надзиратель
...
job-name-cargotech = Складской техник
...
JobBoxer = Боксёр
JobCaptain = Капитан
JobCargoTechnician = Складской техник
