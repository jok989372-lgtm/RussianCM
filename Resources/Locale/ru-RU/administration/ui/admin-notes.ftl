...
admin-note-editor-expiry-placeholder = Укажите срок действия (гггг-мм-дд чч:мм:сс)
...
admin-remarks-fade-note = [italic]Эти замечания исчезнут со временем.[/italic]
admin-remarks-history-note = [italic]Замечания используются для отслеживания истории поведения.[/italic]
