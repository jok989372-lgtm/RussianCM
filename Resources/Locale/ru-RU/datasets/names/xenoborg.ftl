...
names-xenoborg-dataset-48 = публичное убийство в статической пустоте
...
names-xenoborg-dataset-63 = ВОЕННЫЙ отряд
