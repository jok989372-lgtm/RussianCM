...
announce-xeno-ally-status-gain = Наша Королева заключила союз с {$faction}!

announce-xeno-ally-status-loss = Наша Королева разорвала союз с {$faction}!

announce-xeno-ally-person-status-gain = Наша Королева провозгласила {$name} нашим союзником! Мы не должны причинять им вреда.
...
xeno-manage-hive-allies-factions = Управляйте альянсами фракций

xeno-manage-hive-allies-factions-window-name = Переключить альянс фракций

xeno-allies-window-name = Заключить союз с
